...
function switchTab(p1) {
  ...
  document.getElementById("expansionSubTabContainer").style.display = "none";
  ...
  document.getElementById("expansionTab").style.backgroundColor = "var(--primary-3)";
  ...
  document.getElementById("expansionMilestonesContainer").style.display = "none";
  ...
  document.getElementById("expansionMilestonesSubTab").style.backgroundColor = "var(--primary-3)";
...
function prestigeViewChange(p1) {
  document.getElementById("expanionPrestigeView").style.display = "none";
  document.getElementById(p1 + "PrestigeView").style.display = "flex";
  player.currentPrestigeView = p1;
}
...
function themeChange(p1,p2) {
  ...
  document.getElementById("themeBtn").innerHTML = 'Current Theme: ' + themeObject.themeName[player.theme];

  if (p2 !== undefined) {
    console.log(p2.substring(0,5))
    if (p2.substring(0,5) === 'theme') {
      p3 = p2.slice(5);
      console.log(p3);
      player.theme = themeObject.themeName.indexOf(p3);
      document.getElementById("themeBtn").innerHTML = 'Current Theme: ' + p3;
    }
  }
